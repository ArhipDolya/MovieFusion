...
from .views import RegistrationView, LoginView, CommentViewSet, get_comments_for_movie, like_comment, unlike_comment, update_comment_text
...
urlpatterns = [
    ...
    path('api/v1/movie/comments/<int:comment_id>/update/', update_comment_text),
